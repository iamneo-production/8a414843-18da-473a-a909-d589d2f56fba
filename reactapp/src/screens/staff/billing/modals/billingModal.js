...
const getBillingDetails =async() =>{
  await get(`${EndPoints.getBillingDetails}/${records.id}`).then((response)=>{
...
return (
  ...
  <>
    <Modal size={800} opened={open} onClose={close} >
      <form onSubmit={handlePay}>
        ...
        <Grid.Col xs={3} lg={3}>
          {/* {records.appointment.patient.firstName} {records.appointment.patient.lastName} {amountCalc} */}
        </Grid.Col>
